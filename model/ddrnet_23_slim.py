...
def DDRNet_23_slim(n_classes,pretrained=False,augment=False):
    model = DualResNet(BasicBlock, [2, 2, 2, 2], num_classes=n_classes, planes=32, spp_planes=128, head_planes=64, augment=augment)
    if pretrained:
        path = os.path.join(os.path.dirname(__file__),'pretrain','DDRNet23s_imagenet.pth')
