...
def DDRNet_23(n_classes,pretrained=True,augment=False):
    model = DualResNet(BasicBlock, [2, 2, 2, 2], num_classes=n_classes, planes=64, spp_planes=128, head_planes=128, augment=augment)
    if pretrained:
        path = os.path.join(os.path.dirname(__file__),'pretrain','DDRNet23_imagenet.pth')
